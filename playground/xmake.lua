...
target('playground')
  ...
  add_includedirs('../parmscript', '../deps/imgui', '../deps/imgui/misc/cpp', '../deps/imgui/backends', '../deps/lua')
  ...
  add_links('d3d11', 'd3dcompiler', 'gdi32', 'user32', 'shell32', 'advapi32', 'dwmapi')
